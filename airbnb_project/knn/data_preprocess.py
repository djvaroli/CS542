...
def data_preprocessing(full_df,features,normalization = '0-means'):
    ...
    # replace nans with either median value or a 'f' for binary features
    ...
    property_type_dict = {'House':1.5,'Apartment':1.0, 'Other': 0}
    ...
    full_df.replace(response_rate_dict, inplace=True)
